...
//        [Fact]
//        public void GetColumnSchema_NoReaderProvided_EmptyColumns()
//        {
//            MsSqlDataReaderWrapper wrapper = new();
//            var columns = wrapper.GetColumnSchemaAsync();
...
//        [Fact]
//        public void GetColumnSchema_DbReaderProvided_NotEmptyColumns()
//        {
//            reader
//                .Setup(_ => _.GetColumnSchema())
//                .Returns(new ReadOnlyCollection<DbColumn>(new List<DbColumn>() { new DbColumnStub("column-0") }));
